            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-8">
                        ...
                        <p class="text-muted">Sistem Pelatihan Mahasiswa adalah aplikasi berbasis web yang dibuat untuk mempermudah mahasiswa dalam mendaftar pelatihan.</p>
                    </div>
                    <div class="col-sm-4">
        ...
        <div class="navbar navbar-dark btn-success shadow-sm">
            <div class="container">
                <a class="navbar-brand align-items-center" style="color:#fff;">
                    <strong> Daftar Nama Peserta Pelatihan</strong>
                </a>
    ...
    <main role="main">
        <section class="jumbotron text-center" style="background: #fff;">
            <div class="container">
                ...
                ?>
                <h1 class="jumbotron-heading" style="font-style: italic;">Daftar Peserta Pelatihan</h1>
            </div>
        </section>
